...
from hydrat.task.taskset import isOneofM
...
def arff_export(fileobj, model, density_threshold = 0.10):
  ...
  """
  logger = logging.getLogger('hydrat.preprocessor.model.arff.arff_export')
  ...
  logger.info('Exporting model to ARFF')
  # Write header
  ...
  if matrix_density <= density_threshold:
    logger.info('Writing data in sparse format')
    ...
    logger.info('Writing data in dense format')
